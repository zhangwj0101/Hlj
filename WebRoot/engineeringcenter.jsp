...
<html>
  ...
  <body style="background-image:url('images/bg.jpg')"  onload="generateMap('servlet/FindEngineeringCenterAction','map','normal','');">
    <div style="position:relative;top:13px;"><h2 style="width:100%;text-align:center;font-size:40px;letter-spacing:25px"><font color=#ffffff>黑龙江省工程技术研究中心分布</h2></font></div>
