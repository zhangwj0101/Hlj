	...
	preloadStyle : function() {
		...
		var style = "<style type='text/css'>";
			...
			if(!nex.isBar) // center the thumbnails if no bar active
			{
				...
				style += "#nex-thumbnails { margin-left:"+marginLeft+"px ;margin-bottom:-30px;}";
			}
				...
				switch(nex.opt.data[i].display)
				{
					...
					case "video":
						markup += "<li data-nex-display='" + nex.opt.data[i].display + "' data-nex-title='" + nex.opt.data[i].title + "' data-nex-description='" + nex.opt.data[i].description + "'>";
							markup += "<a href='" + nex.opt.data[i].url + "'><img class='nex-" + nex.opt.style.filter + "' src='" + nex.opt.data[i].thumb + "' alt='" + nex.opt.data[i].alt + "' width='80' height='80' /></a>";
						markup += "</li>";
						break;
					case "map":
						markup += "<li data-nex-display='" + nex.opt.data[i].display + "' data-nex-title='" + nex.opt.data[i].title + "' data-nex-description='" + nex.opt.data[i].description + "'>";
							markup += "<a href='#'><img class='nex-" + nex.opt.style.filter + "' src='" + nex.opt.data[i].thumb + "' width='80' height='80' /></a>";
						markup += "</li>";
						break;
					default:
						break;
