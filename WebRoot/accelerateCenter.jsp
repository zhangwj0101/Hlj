...
<html>
  <head>
	...
	<script type="text/javascript" src="js/map_acceleratecenter.js"></script>
  ...
  <body style="background-image:url('images/bg.jpg')" onload="generateMap('servlet/FindAccelerateCenterAction','map','normal','');">
    <div style="position:relative;top:13px;top:10px;"><h2 style="width:100%;text-align:center;font-size:40px;letter-spacing:25px"><font color=#ffffff>黑龙江省生产力促进中心分布情况</h2></font></div>
	<div id="barshow" style="position:absolute;top:80px;float:left;width:576px;min-height:950px;"></div>
        ...
        require(
            ...
            function (ec) {
                ...
                myChart.on('click', function (param) {
                	generateMap('servlet/FindAccelerateCenterAction','map','normal',param.name);
                });
